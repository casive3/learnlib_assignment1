...
public class ExampleExperiment {
    ...
    public static void main(String [] args) throws IOException {
        // Load the actual SUL-class (System Under Learning)
        ...
        // For the last part of the assignment, use the following SUL:
        //SUL<String,String> sul = new SocketSUL(InetAddress.getLoopbackAddress(),7892,true,"reset");
